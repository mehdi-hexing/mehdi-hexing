...
| --- | --- |
| **[Domain-Resolve][1]** | وقتی کاربر یک دامنه وارد می‌کند، Worker به‌جای resolve مستقیم (که می‌تواند سقف Subrequest کلادفلر را پر کند)، این سرویس را صدا می‌زند و لیست IPهای گروه‌بندی‌شده را می‌گیرد |
