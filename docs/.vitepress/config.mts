          ...
          '/topics/': [
            {
              ...
              items: [
                ...
                { text: 'راهنمای راه‌اندازی رایگان Web Proxy تلگرام', link: '/topics/WebProxySetup' },
                { text: 'راهنمای استفاده از سرویس MTProto در بستر katabump', link: '/topics/KataBumpMTProtoSetup' },
                { text: 'راهنمای استفاده و دپلوی کانفیگ در بستر Katabump', link: '/topics/KataBumpConfigSetup' },
              ],
            },
          ],
        },
          ...
          '/en/topics/': [
            {
              ...
              items: [
                ...
                { text: 'Guide to setting up free Telegram Web Proxy', link: '/en/topics/WebProxySetup' },
                { text: 'MTProto service on the Katabump', link: '/en/topics/KataBumpMTProtoSetup' },
                { text: 'Deploying config on the Katabump', link: '/en/topics/KataBumpConfigSetup' },
